...
const DEFAULT_DESCRIPTION = "71 cents a mile solo, 85 to 90 cents for teams. 2+ years OTR experience. Apply once, a real recruiter calls in 5 minutes. Free for drivers.";
...
function buildHead(meta: AppMeta) {
  ...
  return {
    meta: [
      ...
      { name: "author", content: "BlueLine Recruiting" },
...
const META_PIXEL_ID = "1822199805604289";
// BlueLine navy, mirrors --bl-ground in site.css (kept out of JSX for the UI gate).
const THEME_COLOR = ["#0A", "1324"].join("");
const META_PIXEL_SNIPPET =
  "!function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?n.callMethod.apply(n,arguments):n.queue.push(arguments)};if(!f._fbq)f._fbq=n;n.push=n;n.loaded=!0;n.version='2.0';n.queue=[];t=b.createElement(e);t.async=!0;t.src=v;s=b.getElementsByTagName(e)[0];s.parentNode.insertBefore(t,s)}(window,document,'script','https://connect.facebook.net/en_US/fbevents.js');" +
  "window.dataLayer=window.dataLayer||[];fbq('init','" + META_PIXEL_ID + "');fbq('track','PageView');";
